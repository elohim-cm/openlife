...
import { MOBILE_APP_FEATURES, MOBILE_APP_STORES } from "./mobile-app.data";
      ...
      <div className="mx-auto grid min-h-[760px] w-full max-w-[1500px] grid-cols-1 lg:grid-cols-[47%_53%]">
        <div className="relative z-10 flex flex-col justify-center px-5 py-20 sm:px-8 lg:px-10 lg:py-24">
          <div className="mx-auto w-full max-w-[670px] lg:mx-0">
            ...
            <div aria-hidden="true" className="mt-[8px] flex items-center gap-[10px]">
            ...
            <div className="mt-[41px] space-y-[36px]">
              {MOBILE_APP_FEATURES.map((feature) => {
                ...
                return (
                  <article key={feature.id} className="flex items-start gap-[15px]">
              ...
              {MOBILE_APP_STORES.map((store) => {
                ...
                return (
                  <Link
                    key={store.id}
                    href={store.href}
                    aria-label={`Télécharger Open Life sur ${store.label}`}
                    className="group flex min-h-[65px] min-w-[198px] items-center gap-[14px] rounded-[11px] border border-border bg-surface-elevated px-[22px] shadow-card transition-[transform,box-shadow,border-color] duration-300 ease-out hover:-translate-y-1 hover:border-border-strong hover:shadow-card-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-3"
                  >
                    <Icon aria-hidden="true" className="size-[27px] shrink-0 text-accent transition-transform duration-300 group-hover:scale-105" />
        ...
        <div className="mobile-app-theme-background relative flex min-h-[650px] items-center justify-center overflow-hidden lg:min-h-[760px]">
          <div aria-hidden="true" className="pointer-events-none absolute bottom-[-180px] right-[-140px] size-[430px] rounded-full bg-brand-muted/45 blur-3xl" />
