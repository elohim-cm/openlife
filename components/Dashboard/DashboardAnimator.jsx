...
const DashboardAnimator = ({dashboard, onRefresh}) => {
  ...
  useEffect(() => {
    if (dashboard != null && dashboard.subscription != null) {
      setPageData({
        ...
        subscription: dashboard.subscription[0].obj_providers.map(item => ({
        ...
        collection: dashboard.collection[0].obj_providers.map(item => ({
          name: item.provider_name,
...
export default DashboardAnimator;
